...
<div class="game-landing">
	...
	<p class="credits">{isZh ? '插画由 Google Gemini 生成' : 'Illustrations generated by Google Gemini'}</p>
</div>
...
<style>
	...
	.credits { font-size: var(--font-size-2xs); color: var(--color-text-tertiary); margin-top: var(--space-lg); }
</style>
